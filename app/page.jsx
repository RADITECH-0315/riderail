    ...
    <main>
      ...
      <section className="text-center py-16 sm:py-20">
        ...
        <div className="mt-8">
          <a
            href="#book"
            className="inline-block rounded-xl bg-[var(--brand)] px-6 py-3 font-semibold text-slate-900 shadow-md hover:bg-yellow-500 transition"
          >
            Book a Cab
          </a>
        </div>
      ...
      {/* BOOKING FORM */}
      <section id="book" className="container py-12 sm:py-16 reveal">
        <div className="glass-card p-5 sm:p-8">
          ...
          <p className="text-slate-600 mb-6 sm:mb-8 text-center">
            Airport transfers, outstation trips, and rentals in & around
            Chennai.
          </p>
          <BookingForm />
        </div>
      ...
      {/* HOW IT WORKS */}
      <section id="how" className="py-16 sm:py-20 bg-white reveal">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            <div className="card p-6 hover:lift">
              ...
              <p className="text-slate-600">
                Choose pickup & drop, enter details, and confirm.
              </p>
            </div>
            <div className="card p-6 hover:lift">
              <h3 className="font-semibold text-lg mb-1">2. Driver Assigned</h3>
              <p className="text-slate-600">
                Nearest available driver is allocated instantly.
              </p>
            </div>
            <div className="card p-6 hover:lift">
              <h3 className="font-semibold text-lg mb-1">3. Enjoy the Ride</h3>
              <p className="text-slate-600">
                On-time pickup, safe driving & transparent fare.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* TESTIMONIALS */}
      <section id="reviews" className="py-16 sm:py-20 bg-[var(--bg)] reveal">
        <div className="container text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-10 text-[var(--ink)]">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              {
                name: "Arun",
                text: "Smooth airport ride, on-time and professional.",
              },
              {
                name: "Priya",
                text: "Very safe & secure. My go-to in Chennai.",
              },
              {
                name: "Ramesh",
              ...
              <div key={i} className="card p-6 hover:lift">
